...
/**
 * Números de página en vez de solo "Anterior/Siguiente" — con muchas páginas
 * no se listan todas, se muestra la primera, la última, una ventana alrededor
 * de la actual, y "…" donde hay huecos.
 */
