...
/// Solo recuerda el usuario tecleado, nunca la contraseña ni la sesión (esa
/// persistencia ya la maneja la cookie de refresh, aparte).
const _usuarioRecordadoKey = 'exploradores-usuario-recordado';
