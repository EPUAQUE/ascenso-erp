...
/// Paleta única de la app — portada byte-a-byte desde `market-flutter`
/// (mismos tokens petróleo/esmeralda/ámbar). La marca (`brand`/`primary`/
/// `accent`) NO cambia entre claro y oscuro a propósito — solo cambian
/// superficies/texto/borde y los tonos semánticos.
class AppColors {
  const AppColors({
    required this.brand,
