...
/// Cliente HTTP único de la app. Auth por `requiresAuth` (no por URL), un
/// solo refresh en vuelo compartido entre 401 concurrentes, errores siempre
/// normalizados a [ApiException].
///
