 ...
 *
 * <p>{@code @Qualifier("requestMappingHandlerMapping")}: con Actuator en el
 * classpath hay un segundo bean de este tipo — sin desambiguar, el arranque falla
 * por {@code NoUniqueBeanDefinitionException}.
 */
@Component
