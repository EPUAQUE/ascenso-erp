...
/**
 * Catálogo de roles de negocio. {@code alcanceGlobal = true} (ej. SUPERVISOR_GENERAL)
 * permite operar sobre cualquier destacamento sin necesidad de asignación explícita
 * en {@link UsuarioDestacamento}.
 */
public class Rol {
