...
/**
 * Generación y hash del refresh token opaco. Usa solo JDK estándar: SecureRandom
 * para generar 256 bits de entropía, SHA-256 para el hash almacenado en servidor.
 */
